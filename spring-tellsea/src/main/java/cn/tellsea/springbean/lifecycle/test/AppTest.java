package cn.tellsea.springbean.lifecycle.test;

import cn.tellsea.springbean.lifecycle.config.AppConfig;
import cn.tellsea.springbean.lifecycle.config.PersonBean;
